# Template yii-advanced-app-2.0.37
...
You can perform this work by running *genAppStructure.2.0.37.php*, which is put in the same directory with this README.md file.
...
If it's difficult to install dependencies via *composer*, you can extract the *vendor* directory from the [yii2 advanced application template archive file](https://github.com/yiisoft/yii2/releases/download/2.0.37/yii-advanced-app-2.0.37.tgz), and copy it to *yii2* directory.
